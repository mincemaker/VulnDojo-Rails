...
| 手法 | 用途 | 使用チャレンジ |
|------|------|------|
| `Module#prepend` | コントローラのアクションメソッドを上書き | xss, sqli, idor, open_redirect, mass_assign, session_fix, cmd_inj, broken_auth_timing, ssrf |
...
├── test/integration/vulnerabilities/     # E2E テスト (106テスト, 239アサーション)
